def Turbine_nozzle(m_p,Pc,Tc,Prop,Pamb,Default):
    ...
    card_str="""
    oxid {Ox} {Propellant.Ox_composition} 
    h,kj/mol={h_ox} t(k)={Tc} rho={rho_ox}
    """
    add_new_oxidizer('Ox_turbine',card_str)

    card_str="""
    fuel {Fuel} {Propellant.Fuel_composition} 
    h,kj/mol={h_fuel} t(k)={Tc} rho={rho_fuel}
    """
