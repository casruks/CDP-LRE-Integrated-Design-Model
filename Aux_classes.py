...
class Default:
    ...
    Max_iterations_mass_flow = (
        10000  # Maximum iteration for the third part of Nozzle_1 code (Nozzle_1)
    )
    toll_P_adapted = 0.01  # Tollerance on the normalized difference between exit pressure and ambient pressure (Nozzle_1)
    noz_res = (
        150  # Number of points in the discretization of the whole nozzle (Nozzle_2)
    )
