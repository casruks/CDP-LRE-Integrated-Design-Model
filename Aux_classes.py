...
class Default:
    ...
    Cd = 0.7
    d_ox = d_f = (
        (0.0135 + 0.281) * 0.0254 / 2.0
    )  # 3.74 mm http://libgen.rs/book/index.php?md5=3D236B9BDD4070690CA83952058D9A1F p.113
    ...
    InjTypes = [
        ...
        "unlike",
        "pintle",
    ]  # Please keep this one in default as well. Used for Injector1() via Default.InjTypes
    ...
    De_turbine_noz_max = (
        2.5  # Maximum exit diameter for the turbine exhaust nozzle LIMIT: >0
    )
    Theta_con = (
        45  # Angle of the convergent part of the nozzle in degrees  LIMITS: 0<THETA<90
    )
    ...
    D_0 = (
        1.50 * 10**-4
    )  # this is just a placeholder, bc the values from the injectors were not okay, do not put on inputs
    ...
    Prop = [
        "LOX_LH2",
        "LOX_RP1",
    ]  # Only used for de-rating or up-rating, so does not impact general reliability.
...
class Propellant:
    ...
    def Rp1(self):
        ...
        self.fcp = 1.88 * 10**6  # fuel cp
        self.h_fuel = -1758.456  # fuel enthalpy
        self.R_f = 47.5  # fuel gas constant
        self.f_lamb = 1.6e-6
        self.fmiu = 2.166e-6
        self.f_nist_enthalpy_coef = [
            120.4010,
