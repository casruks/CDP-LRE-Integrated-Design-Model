...
def Main(d : aux.Data):
    ...
    while abs(p_new-p_old)/p_new > default.pres_tol:
        ...
        ## Default class
        t_noz,x_noz,y_noz,Tw_ad_noz,h_c_noz,d.D_t,d.D_e,d.L_nozzle_con,d.L_nozzle_div,d.L_tot,x_noz_cool,y_noz_cool,errors_nz2,warnings_nz2=Nz_2.Nozzle_loop(p_new/100000.0, d.Tc, prop, Ms.Rhenium, default.Nozzle_type, d.O_F, d.eps, d.At, d.m_nozz, d.Dc, default)
        #Outputs
